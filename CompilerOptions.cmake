...
if (CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
	target_compile_options(${NANOSTATION_LIB} PUBLIC ${CLANG_FLAGS})
elseif (CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    target_compile_options(${NANOSTATION_LIB} PUBLIC ${GCC_FLAGS})
elseif (MSVC)
	target_compile_definitions(${NANOSTATION_LIB} PUBLIC _CRT_SECURE_NO_WARNINGS)
	target_compile_options(${NANOSTATION_LIB} PUBLIC ${MSVC_FLAGS})
endif()
